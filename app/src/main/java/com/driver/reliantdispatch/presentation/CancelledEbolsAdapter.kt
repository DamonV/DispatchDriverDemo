...
import com.driver.reliantdispatch.databinding.ViewEbolCancelledRowBinding
import com.driver.reliantdispatch.domain.entities.joined.EbolJoined


class CancelledEbolsAdapter(
    val mViewModel: CancelledViewModel,
    val mActivity: FragmentActivity
): PagedListAdapter<EbolJoined, CancelledEbolsAdapter.ViewHolder>(diffCallback){

    class ViewHolder(val binding: ViewEbolCancelledRowBinding): RecyclerView.ViewHolder(binding.root){
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ViewEbolCancelledRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
